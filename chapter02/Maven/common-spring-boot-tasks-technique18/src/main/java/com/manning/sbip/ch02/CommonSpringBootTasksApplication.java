...
public class CommonSpringBootTasksApplication {
    ...
    public CommandLineRunner printCourses(CourseRepository courseRepository, AuthorRepository authorRepository) {
        return args -> {
            ...
            logger.info("The Course and Author information for Author ID 2:");
            authorRepository.getAuthorCourseInfo(2).forEach(authorCourseDto -> logger.info(authorCourseDto.toString()));
